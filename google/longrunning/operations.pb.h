...
inline void OperationInfo::clear_metadata_type() {
  metadata_type_.ClearToEmpty(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
...
inline void OperationInfo::_internal_set_metadata_type(const std::string& value) {
  ...
  metadata_type_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value, GetArena());
}
...
inline std::string* OperationInfo::_internal_mutable_metadata_type() {
  ...
  return metadata_type_.Mutable(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
